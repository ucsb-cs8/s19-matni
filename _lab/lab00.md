...
assigned: 2019-04-08 13:00:00.00-7
due: 2019-04-14 17:00:00.00-7
---
# This lab is due on Sunday, April 14th, by 11:59 PM

Submit it on Gradescope - see instructions below for how to do this.
Please read the instructions carefully and completely.

# Introduction

This lab is an introduction to Python programming using the Linux Computers in Phelps 3525 and CSIL.  You will write your first Python program that will print a specific text output on your computer display.  The TAs in the lab are there to assist you. The Peer Tutors will also be there to help you out when needed.   
...
```python
# Chris Gaucho, for CMPSC 8, Spring 2019
print ('Hello, World!')
```
